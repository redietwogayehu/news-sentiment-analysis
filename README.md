...
Future Improvements-
Sentiment enhancement using FinBERT or transformer-based models
More advanced correlation techniques (lagged correlation, rolling correlation)
Predictive modeling for short-term price movement
Interactive dashboard (Streamlit or Power BI)
Expansion to multi-stock portfolio sentiment tracking
